      ...
      <div className="max-w-4xl mx-auto px-8 py-24">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-cyan-400 text-xs">Let's connect and build something amazing</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          {/* Email Contact */}
          <div className="bg-[#0B0B0C] border border-[#2A2A2A] rounded-xl p-6 hover:bg-[#1A1A1A] hover:border-cyan-400/50 transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-[#9A9A9A] text-xs">Quick response guaranteed</p>
              </div>
            </div>
          ...
          <div className="bg-[#0B0B0C] border border-[#2A2A2A] rounded-xl p-6 hover:bg-[#1A1A1A] hover:border-cyan-400/50 transition-all duration-300 hover:scale-[1.03]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-[#9A9A9A] text-xs">Let's discuss your project</p>
              </div>
            </div>
        ...
        <div className="mb-12">
          <h2 className="text-white font-semibold mb-4">Follow Me Online</h2>
          <p className="text-[#9A9A9A] text-sm mb-6">Stay updated with my latest projects and thoughts</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {socialLinks.map((social, index) => (
              ...
              >
                ...
                <h3 className="text-white font-medium text-sm mb-1">{social.label}</h3>
                <p className="text-[#9A9A9A] text-xs">{social.description}</p>
              </div>
            ))}
          </div>
        </div>
